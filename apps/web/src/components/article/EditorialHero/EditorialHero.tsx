...
export function EditorialHero(props: EditorialHeroProps) {
  ...
  // `apps/web/test/e2e/article-detail.spec.ts` can assert the per-type hero
  // rendered. Inherits the legacy `data-testid="<type>-hero"` contract from
  // the (now-superseded) per-variant Hero components.
  return (
