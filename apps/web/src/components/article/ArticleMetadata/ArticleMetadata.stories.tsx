...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Design §7.6 article metadata bar: single row, 1px paper-edge rules top + bottom, mono small-caps facts cluster on the left, one labelled “Delen” button (44px tap target, DESIGN.md “The Tap Target Rule”, #2529) on the right.",
      },
    },
  },
  tags: ["autodocs", "vr"],
