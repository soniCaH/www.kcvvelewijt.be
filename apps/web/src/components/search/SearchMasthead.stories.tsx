...
const meta = {
  ...
  // VR determinism (#3033): force the nested <SearchForm>'s focus-ring to
  // a state the story declares rather than one dependent on the runner's
  // real frame focus — see search-form-vr-focus.ts.
