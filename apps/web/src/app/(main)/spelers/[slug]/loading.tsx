 ...
 * `<PlayerHero>` block, `<StripedSeam>`, and a bio paragraph
 ...
 * only. `<MatchStripSlot>` is not drawn here: `./layout.tsx` mounts the
 * real strip above this file, so it stays on screen while the page loads
 * (#3027).
 */
