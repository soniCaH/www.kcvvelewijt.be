...
// `page.tsx`'s own 86400s window rather than the general 900s cap
// (`cross-page-consistency.test.ts` rule 5): `/staf/[slug]` is the one route
// #2433 deliberately left at 86400 despite degrading a Sanity section, and this
// image shares the same subject and the same webhook- freshness argument (#2863
...
export default async function Image({ params }: ImageProps) {
  ...
  // `StaffRepository.findByPsdId` carries a typed `SanityReadError` (#2864),
