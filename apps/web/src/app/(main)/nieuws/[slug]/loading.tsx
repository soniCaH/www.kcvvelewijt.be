    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-72 animate-pulse bg-gray-200 md:h-96">
        <div className="absolute right-0 bottom-0 left-0 bg-linear-to-t from-black/70 to-transparent p-6">
          <div className="mx-auto max-w-[var(--container-wide)] space-y-3">
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="mx-auto flex max-w-[var(--container-wide)] animate-pulse gap-4 px-4 py-3 md:px-8">
      ...
      {/* Article body prose */}
      <div className="mx-auto max-w-[var(--container-prose)] animate-pulse space-y-4 px-4 py-8 md:px-8">
      ...
      <div className="border-t border-gray-200 bg-gray-50">
        <div className="mx-auto max-w-[var(--container-wide)] animate-pulse px-4 py-8 md:px-8">
