 ...
 * Matches the SectionStack layout: hero + editorial + team grid + mission + CTA
 */
...
export default function JeugdLoading() {
  return (
    <div className="min-h-screen">
      ...
      <div className="relative h-[60vh] min-h-[400px] bg-kcvv-black animate-pulse">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 z-10">
          <div className="max-w-5xl mx-auto space-y-4">
            ...
            <div className="h-5 w-72 max-w-full rounded bg-white/15" />
          </div>
        </div>
      </div>
      ...
      {/* Section 3: Teams by age group (dark) */}
      ...
      <div className="bg-kcvv-black py-16">
        <div className="max-w-3xl mx-auto px-4 text-center animate-pulse space-y-4">
          ...
          <div className="h-8 w-80 max-w-full rounded bg-white/10 mx-auto" />
