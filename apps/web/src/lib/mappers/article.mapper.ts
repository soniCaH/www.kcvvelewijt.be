...
/**
 * Convert a SanityArticleListItem into a HomepageArticle suitable for homepage display.
 *
...
/**
 * Map an array of SanityArticleListItem objects to HomepageArticle entries for the homepage.
 *
...
export function mapSanityArticlesToHomepageArticles(
  articles: readonly SanityArticleListItem[],
  includeDescription = false,
): HomepageArticle[] {
