...
// Query: *[_type == "homePage"][0] {    "bannerSlotA": bannerSlotA-> {      "imageUrl": image.asset->url + "?w=1200&h=200&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      "imageUrlMobile": image.asset->url + "?w=720&h=240&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      alt,      href    },    "bannerSlotB": bannerSlotB-> {      "imageUrl": image.asset->url + "?w=1200&h=200&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      "imageUrlMobile": image.asset->url + "?w=720&h=240&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      alt,      href    },    "bannerSlotC": bannerSlotC-> {      "imageUrl": image.asset->url + "?w=1200&h=200&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      "imageUrlMobile": image.asset->url + "?w=720&h=240&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(image.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(image.hotspot.y, 0.5)),      alt,      href    },    "matchesSliderPlaceholder": matchesSliderPlaceholder {      nextSeasonKickoff,      announcementText,      announcementHref,      "highlightImage": highlightImage {        alt,        "asset": asset->{          "url": url + "?w=1344&h=320&q=80&fm=webp&fit=crop&crop=focalpoint&fp-x=" + string(coalesce(^.hotspot.x, 0.5)) + "&fp-y=" + string(coalesce(^.hotspot.y, 0.5)),          "lqip": metadata.lqip        }      }    },    "youthPlayerCount": youthPlayerCount,    "youthTeamCount": youthTeamCount  }
