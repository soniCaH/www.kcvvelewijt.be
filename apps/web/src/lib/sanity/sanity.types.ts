...
export type STAFF_MEMBER_BY_PSD_ID_QUERY_RESULT = {
  ...
  organigramPositions: Array<{
    title: string | null;
    roleCode: string | null;
    department: "hoofdbestuur" | "jeugdbestuur" | "algemeen" | null;
  }>;
