 ...
 *   npx sanity@latest migration run set-homepage-youth-stats --project vhb33jaz --dataset staging
 *   npx sanity@latest migration run set-homepage-youth-stats --project vhb33jaz --dataset production
 */
