 ...
 * draft referrer, a slug-clash check that must catch a slug taken by a
 * draft-only document, or a delete sweep that must not leave a draft-only
 * twin behind. Each call site names the reason next to the call (#2839).
 */
