 ...
 *
 * Run: SANITY_API_TOKEN=... SANITY_DATASET=staging pnpm --filter @kcvv/sanity-ops staff:phase1
 */
...
const MANUAL_STAFF: ManualStaff[] = [
  {
    _id: "staffMember-manual-rudy-bautmans",
    firstName: "Rudy",
    lastName: "Bautmans",
  },
  {
    _id: "staffMember-manual-ilona-trouwkens",
    firstName: "Ilona",
    lastName: "Trouwkens",
  },
  {
    _id: "staffMember-manual-matthias-knevels",
    firstName: "Matthias",
    lastName: "Knevels",
  },
  {
    _id: "staffMember-manual-werner-sanfrinnon",
    firstName: "Werner",
    lastName: "Sanfrinnon",
  },
  {
    _id: "staffMember-manual-igor-michiels",
    firstName: "Igor",
    lastName: "Michiels",
  },
  {
    _id: "staffMember-manual-mike-vermoes",
    firstName: "Mike",
    lastName: "Vermoes",
  },
  {
    _id: "staffMember-manual-kim-bautmans",
    firstName: "Kim",
    lastName: "Bautmans",
  },
  {
    _id: "staffMember-manual-dennis-thyssens",
    firstName: "Dennis",
    lastName: "Thyssens",
  },
  {
    _id: "staffMember-manual-sven-de-smedt",
    firstName: "Sven",
    lastName: "De Smedt",
  },
  {
    _id: "staffMember-manual-shauni-hellemans",
    firstName: "Shauni",
    lastName: "Hellemans",
  },
  {
    _id: "staffMember-manual-fred-degryse",
    firstName: "Fred",
    lastName: "Degryse",
  },
  {
    _id: "staffMember-manual-lena-van-marsenille",
    firstName: "Lena",
    lastName: "Van Marsenille",
  },
  {
    _id: "staffMember-manual-paul-vanhamme",
    firstName: "Paul",
    lastName: "Vanhamme",
  },
  {
    _id: "staffMember-manual-chris-nobels",
    firstName: "Chris",
    lastName: "Nobels",
  },
  {
    _id: "staffMember-manual-jurgen-vergalle",
    firstName: "Jurgen",
    lastName: "Vergalle",
  },
  {
    _id: "staffMember-manual-pieter-de-keyser",
    firstName: "Pieter",
    lastName: "De Keyser",
  },
];
...
async function deleteDraftDuplicate() {
  ...
  if (!exists) {
    console.log(
      `Draft ${DRAFT_DUPLICATE_ID} not found — already deleted or never existed.`,
    );
    return;
  }
