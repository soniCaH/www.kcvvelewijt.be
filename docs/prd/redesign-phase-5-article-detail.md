...
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 5.d1 | ~~Article header — centered or flanked?~~ **LOCKED 2026-05-18 → E0 (existing Phase 3-b `<EditorialHeroShell>` 60/40 shell stands).** All four proposed alternatives (A flanked / B stacked / C hybrid / D full-width spotlight) required dropping locked primitives; comparison confirmed the Phase 3-b lock holds. See `docs/design/mockups/phase-5-article-detail/header-locked.md` + `5d1-header/compare.md`. Per-variant overlays drilled inside each variant drill (5.d-int / 5.d-tra / 5.d-evt / 5.d-mat). | Universal hero shell for every article variant (= Phase 3-b lock).                                                                                                                                                                                        |
