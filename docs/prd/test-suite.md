...
| #3135 — the last 5 prerender sites degrade                           | §0.3               | —                          |
...
- **Degrading a static-params read** — four of nine sites already do it; §0.3 finishes the pattern on the remaining five.
