/**
 * Per-document-type editor guidance shown in the always-visible guide panel at
 * the top of the document form. A type opts in by having an entry in
 * `guideContent`; types without one render Sanity's default form unchanged.
 *
 ...
 * shows that reliably, and the guide can't see the form's live validation
